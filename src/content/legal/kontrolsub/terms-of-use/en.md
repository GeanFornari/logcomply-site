...
- Manage free trial periods (*trial*) and billing dates.
...
The user may, at any time, link their anonymous account to:

- **Google:** via Google Sign-In.
- **Apple:** via Sign In with Apple (exclusive to iOS users).

Linking is not mandatory, but is recommended to ensure data is preserved in case of device change or App reinstallation.
...
The user agrees to use the App exclusively for lawful and personal purposes. The following are expressly prohibited:

- Using the App for any illegal or unauthorized purpose.
- Attempting to reverse engineer, decompile, or extract the App's source code.
- Entering false information with the intent to deceive other users or systems.
- Using the App to collect data from third parties without their consent.
...
To the maximum extent permitted by applicable law, the developer will not be liable for any indirect, incidental, special, or consequential damages arising from the use of or inability to use the App, including, without limitation, loss of data or profits.
...
These Terms are governed by the laws of the **Federative Republic of Brazil**. For international users, disputes that cannot be resolved amicably may also be subject to the mandatory consumer protection laws of the user's country of residence, to the extent required by applicable law.
